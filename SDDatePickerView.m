...
#define DP_ScreenW [UIScreen mainScreen].bounds.size.width
#define DP_ScreenH [UIScreen mainScreen].bounds.size.height
...
#define DP_ColorRGB(rgb)    [UIColor colorWithRed:(rgb)/255.0 green:(rgb)/255.0 blue:(rgb)/255.0 alpha:1.0]

#define DP_height 260.0f  //默认高度

@interface SDDatePickerView () <UIPickerViewDelegate, UIPickerViewDataSource>
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backButton = [[UIButton alloc] initWithFrame:[UIScreen mainScreen].bounds];
...
+(instancetype)showDataPickerViewWithTitle:(NSString *)title delegate:(id <SDDatePickerViewDelegate>)delegate{
    SDDatePickerView *view = [[SDDatePickerView alloc] initWithFrame:CGRectMake(0, DP_ScreenH, DP_ScreenW, DP_height)];
    view.title = title;
...
- (void)configToolView {
    ...
    [saveBtn setTitleColor:DP_ColorRGB(34) forState:UIControlStateNormal];
    ...
    [cancelBtn setTitleColor:DP_ColorRGB(34) forState:UIControlStateNormal];
    ...
    self.titleLbl.textColor = DP_ColorRGB(34);
...
- (void)show {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        self.frame = CGRectMake(0, DP_ScreenH - DP_height - SAFE_MARGIN_BOTTOM, DP_ScreenW, DP_height);
...
- (void)saveBtnClick {
    ...
    //block 回调
    if (self.completion) {
        self.completion(self.selectStr);
    }
...
- (void)cancelBtnClick {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        self.backButton.alpha = 0;
        self.frame = CGRectMake(0, DP_ScreenH, DP_ScreenW, DP_height);
